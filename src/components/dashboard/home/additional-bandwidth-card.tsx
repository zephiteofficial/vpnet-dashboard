    ...
    <AlertDialog>
      ...
      <Card className="bg-inherit col-span-2">
        <CardHeader className="pb-1">
          <div className="flex">
            <CardDescription className="text-xs md:text-sm font-semibold text-secondary-foreground">Extra Bandwidth</CardDescription>
        ...
        <CardContent>
          <div className="text-xs font-semibold text-muted-foreground">
            {data? `of excess data availaible` :<Skeleton className="mt-2 w-[128px] h-[8px] rounded-full" />}
          </div>
        </CardContent>
        <CardFooter>
