  ...
  return(
    <Card className="col-span-2 md:col-span-4 lg:col-span-4 row-start-1 lg:row-start-2 bg-inherit">
      ...
      <CardContent className="space-y-2">
        ...
        */}
        <Card className="flex items-center h-20 px-4 bg-destructive">
          <div><IconAlertCircle className="mr-4" size={24}/></div>
          <div><p className="text-xs md:text-sm font-medium">The servers will be shutting down on 31st of July, 2026. Payments are already closed. It was a pleasure serving you all.</p></div>
        </Card>
        <Card className="flex items-center h-16 px-4 bg-inherit">
