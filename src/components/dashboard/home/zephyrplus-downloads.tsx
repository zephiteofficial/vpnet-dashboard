    ...
    <Card className="col-span-2 row-start-3 lg:row-start-2 bg-inherit">
      ...
      <CardContent className="space-y-2">
        <Card className="flex items-center h-16 px-4 bg-inherit">
          ...
          <div><p className="text-xs md:text-sm font-semibold"><Link className="hover:underline" to={"https://github.com/zephiteofficial/vpnet-dashboard/releases/download/alpha/ZephyrPlus.Installer.exe"}>ZephyrPlus Windows Client</Link></p></div>
        </Card>
      </CardContent>
    </Card>
  )
