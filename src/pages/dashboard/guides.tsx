        ...
        <div className=''>
          <Accordion type="single" collapsible defaultValue={window.screen.width >= 768 ? "item" : ""}>
            <AccordionItem value="windows-guide">
              <AccordionTrigger className='hover:no-underline'>How To Set Up A VPNet Connection On Windows</AccordionTrigger>
              <AccordionContent>
                <h3 className='text-base font-medium pb-1'>Creating a VPNet Profile</h3>
                <ol className='pl-2 space-y-1'>
                  ...
                  <li><span className='font-semibold'>2.</span> In the <strong className='font-medium'>Add a VPN connection</strong> window, fill out the form with the following details:
                    <ul className='pl-2 py-2 space-y-0.5'>
                      ...
                      <li><strong className='font-medium'>- Server name or address:</strong> Type the <Link className='underline' to={"/servers"}>address</Link> for a VPNet server.</li>
                      <li><strong className='font-medium'>- VPN type:</strong> Choose <em>IKEv2</em> from the dropdown menu.</li>
                      <li><strong className='font-medium'>- Type of sign-in info:</strong> Select username and password and enter your <Link className='underline' to={"/servers"}>VPNet Credentials</Link>.</li>
                    </ul>
                  </li>
                  <li><span className='font-semibold'>3.</span> Click <strong className='font-medium'>Save</strong> to create your VPN profile.</li>
                </ol>
                <h3 className='text-base font-medium pb-1 pt-4'>Connecting to the VPNet Server</h3>
                <p>Once your VPNet profile is set up, you can connect to it through either the taskbar <strong className='font-medium'>( Network icon &gt; VPN )</strong> or the Windows Settings page <strong className='font-medium'>( Start &gt; Settings &gt; Network & internet &gt; VPN )</strong>.</p>
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="android-guide">
              <AccordionTrigger className='hover:no-underline'>How To Set Up A VPNet Connection On Android</AccordionTrigger>
              <AccordionContent>
              <h3 className='text-base font-medium pb-1'>Creating a strongSwan VPNet Profile</h3>
                <ol className='pl-2 space-y-1'>
                  ...
                  <li><span className='font-semibold'>2.</span> Click on <strong className='font-medium'>ADD VPN PROFILE</strong> button and fill out the form with the following details:
                    <ul className='pl-2 py-2 space-y-0.5'>
                      <li><strong className='font-medium'>- Server:</strong> Type the <Link className='underline' to={"/servers"}>address</Link> for a VPNet server.</li>
                      <li><strong className='font-medium'>- VPN type:</strong> Choose <em>IKEv2 EAP (Username/Password)</em> from the dropdown menu.</li>
                      <li><strong className='font-medium'>- Username and Password:</strong> Enter your <Link className='underline' to={"/servers"}>VPNet Credentials</Link>.</li>
                    </ul>
                  </li>
                  <li><span className='font-semibold'>3.</span> Click <strong className='font-medium'>Save</strong> to create your VPN profile.</li>
                </ol>
            ...
            <AccordionItem value="ios-guide">
              <AccordionTrigger className='hover:no-underline'>How To Set Up A VPNet Connection On iOS</AccordionTrigger>
              <AccordionContent>
              <h3 className='text-base font-medium pb-1'>Creating an VPNet Profile on iOS</h3>
                <ol className='pl-2 space-y-1'>
                  ...
                  <li><span className='font-semibold'>3.</span> Tap <strong className='font-medium'>Add VPN Configuration</strong> and fill out the form with the following details:
                    <ul className='pl-2 py-2 space-y-0.5'>
                      ...
                      <li><strong className='font-medium'>- Server and Remote ID:</strong> Type the <Link className='underline' to={"/servers"}>address</Link> for a VPNet server.</li>
                      <li><strong className='font-medium'>- User Authentication:</strong> Select Username and enter your <Link className='underline' to={"/servers"}>VPNet Credentials</Link>.</li>
                    </ul>
                  </li>
